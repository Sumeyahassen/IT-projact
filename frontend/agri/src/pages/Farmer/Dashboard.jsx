      ...
      <div className="p-4 md:p-8 max-w-7xl mx-auto">
        ...
        <div className="mb-12 text-center md:text-left">
          ...
          <p className="text-xl text-gray-700">
            Region: <span className="font-semibold">{user.region || 'Not specified'}</span>
          </p>
        </div>
        ...
        <section className="mb-16">
          ...
          {prices.length === 0 ? (
            <div className="bg-gray-100 p-10 rounded-xl text-center">
              <p className="text-xl text-gray-600">No market prices available yet.</p>
              <p className="text-gray-500 mt-2">Agents will update prices soon.</p>
            </div>
          ) : (
              ...
              {prices.map((p) => (
                ...
                >
                  ...
                  <p className="text-4xl font-bold text-green-600 mb-2">
                    {p.price_per_kg} <span className="text-lg font-normal">ETB/kg</span>
                  </p>
        ...
        <section>
          <h2 className="text-3xl font-bold text-green-800 mb-8">Latest Notifications & Advice</h2>
          {notifications.length === 0 ? (
            <div className="bg-gray-100 p-10 rounded-xl text-center">
              <p className="text-xl text-gray-600">No notifications yet.</p>
              <p className="text-gray-500 mt-2">Extension officers will send advice soon.</p>
            </div>
          ) : (
            <div className="space-y-8">
              {notifications.map((n) => (
                ...
                >
                  <h3 className="text-2xl font-bold text-green-800 mb-4">{n.title}</h3>
                  <p className="text-lg text-gray-700 mb-4 leading-relaxed">{n.message}</p>
