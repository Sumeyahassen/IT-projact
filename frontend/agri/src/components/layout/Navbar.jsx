          ...
          <div className="flex items-center gap-6">
            {user.role ? (
              ...
              <div className="flex gap-4">
                <Link to="/login" className="px-5 py-2 rounded-lg hover:bg-green-600 transition">
                  Login
                </Link>
                <Link to="/register" className="bg-white text-green-700 px-5 py-2 rounded-lg hover:bg-gray-100 transition">
                  Register
                </Link>
              </div>
            )}
